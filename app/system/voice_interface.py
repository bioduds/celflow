...
This module provides voice interaction capabilities for SelFlow including:
...
class VoiceInterface:
    """
    Voice Interface System for SelFlow

    Provides speech-to-text, voice command processing, and audio feedback
    capabilities for hands-free interaction with the SelFlow system.
    """
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.wake_words = self.voice_config.get(
            "wake_words", ["hey selflow", "selflow"]
        )
