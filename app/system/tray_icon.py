...
class EmbryoStatusDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("SelFlow - Embryo Pool Status")
    ...
    def setup_ui(self):
        ...
        # Title
        title = QLabel("🧬 SelFlow Learning Status")
        title_font = QFont()
...
class SelFlowTrayIcon(QSystemTrayIcon):
    """
    System tray icon that evolves as the agent ecosystem develops.
    Shows different menus and options based on the current learning phase.
    """
    ...
    def setup_icon(self):
        ...
        # Set tooltip
        self.setToolTip("SelFlow - Learning your patterns")
    ...
    def update_menu_for_phase(self):
        ...
        if self.current_phase == 0:  # Silent observation phase
            ...
            self.menu.addAction("❌ Quit SelFlow", self.quit_application)
    ...
    def show_quick_status(self):
        ...
        if self.pool_status:
            ...
            self.showMessage("SelFlow Status", message, 
    ...
    def update_display(self):
        ...
        if self.pool_status:
            ...
            if self.current_phase == 0:
                tooltip = f"SelFlow - Observing ({active_embryos} embryos, {patterns} patterns)"
            elif self.current_phase == 1:
                tooltip = f"SelFlow - Learning patterns ({patterns} detected)"
            else:
                tooltip = f"SelFlow - Active ({active_embryos} embryos active)"
    ...
    def advance_to_phase(self, new_phase: int):
        ...
        if new_phase > self.current_phase:
            ...
            self.showMessage("SelFlow Evolution", 
