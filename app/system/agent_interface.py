#!/usr/bin/env python3
"""
SelFlow Agent-User Interaction Interface
...
class AgentChatInterface:
    ...
    def __init__(self, agent_manager: AgentManager):
        ...
        self.response_templates = {
            ...
            "general_help": """I'm SelFlow, your AI operating system! Here's how you can interact with me:
...
*"{agent.blueprint.introduction}"*"""
    ...
    async def _show_system_status(self) -> AgentResponse:
        ...
        try:
            ...
            content = f"""**SelFlow System Status:**
